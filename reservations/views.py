...
def reservation_list(request):
    ...
    # Ajout de débogage
    print("Fonction reservation_list appelée")
    messages.info(request, "Chargement de la liste des réservations")
...
def reservation_detail(request, pk):
    ...
    # Ajout de débogage
    print(f"Fonction reservation_detail appelée pour la réservation {pk}")
    messages.info(request, f"Consultation de la réservation #{pk}")
...
def create_reservation(request):
    ...
    # Ajout de débogage
    print("Fonction create_reservation appelée")
    messages.info(request, "Création d'une nouvelle réservation")
...
def create_payment(request, reservation_id):
    ...
    # Ajout de débogage
    print(f"Fonction create_payment appelée pour la réservation {reservation_id}")
    messages.info(request, f"Création d'un paiement pour la réservation #{reservation_id}")
...
def reservation_confirmation(request, pk):
    ...
    # Ajout de débogage
    print(f"Fonction reservation_confirmation appelée pour la réservation {pk}")
    messages.info(request, f"Confirmation de la réservation #{pk}")
...
def cancel_reservation(request, pk):
    ...
    # Ajout de débogage
    print(f"Fonction cancel_reservation appelée pour la réservation {pk}")
    messages.info(request, f"Tentative d'annulation de la réservation #{pk}")
...
def check_in(request, pk):
    ...
    # Ajout de débogage
    print(f"Fonction check_in appelée pour la réservation {pk}")
    messages.info(request, f"Tentative de check-in pour la réservation #{pk}")
...
def check_out(request, pk):
    ...
    # Ajout de débogage
    print(f"Fonction check_out appelée pour la réservation {pk}")
    messages.info(request, f"Tentative de check-out pour la réservation #{pk}")
...
def manage_services(request):
    ...
    # Ajout de débogage
    print("Fonction manage_services appelée")
    messages.info(request, "Gestion des services additionnels")
...
def service_update(request, pk):
    ...
    # Ajout de débogage
    print(f"Fonction service_update appelée pour le service {pk}")
    messages.info(request, f"Mise à jour du service #{pk}")
...
def service_delete(request, pk):
    """Supprime un service"""
    # Ajout de débogage
    print(f"Fonction service_delete appelée pour le service {pk}")
    messages.info(request, f"Suppression du service #{pk}")
...
def payment_form(request, reservation_id):
    ...
    # Ajout de débogage
    print(f"Fonction payment_form appelée pour la réservation {reservation_id}")
    messages.info(request, f"Formulaire de paiement pour la réservation #{reservation_id}")
...
def process_payment(request, reservation_id):
    ...
    # Ajout de débogage
    print(f"Fonction process_payment appelée pour la réservation {reservation_id}")
    messages.info(request, f"Traitement du paiement pour la réservation #{reservation_id}")
...
def search_results(request):
    ...
    # Ajout de débogage
    print("Fonction search_results appelée")
    messages.info(request, "Recherche en cours...")
